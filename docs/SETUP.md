# Personalizer — Setup & Operations Guide

> The project overview lives in the [README](../README.md). This page is the full operator guide: accounts, configuration, running, verification and troubleshooting.
